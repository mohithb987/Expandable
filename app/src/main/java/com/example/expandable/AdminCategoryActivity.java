...
public class AdminCategoryActivity extends AppCompatActivity {
     ...
     ImageView glasses,hatCaps,walletsBagPurses,shoes;
     ImageView headPhones,laptos,watches,mobilePhones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walletsBagPurses = findViewById(R.id.purse_bags);
        shoes = findViewById(R.id.shoes);
        headPhones = findViewById(R.id.headphones);
        laptos = findViewById(R.id.pcs);
        ...
        walletsBagPurses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminCategoryActivity.this,AdminAddNewProductActivity.class);
                intent.putExtra("category","walletsBagPurses");
                startActivity(intent);
            }
        });
